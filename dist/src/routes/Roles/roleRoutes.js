 ...
 */
roleRoutes.post("/create", Roles_1.createRole);
/**
 * @swagger
 * /api/roles/getall:
 *   get:
 ...
 *         description: Forbidden - Admin access required
 */
roleRoutes.get("/getall", Roles_1.getAllRoles);
/**
 * @swagger
 * /api/roles/{id}:
 *   get:
 ...
 */
roleRoutes.get("/:id", Roles_1.getRoleById);
/**
 * @swagger
 * /api/roles/update/{id}:
 *   put:
 ...
 *         description: Role not found
 */
roleRoutes.put("/update/:id", Roles_1.updateRole);
/**
 * @swagger
 * /api/roles/delete/{id}:
 *   delete:
 ...
 *         description: Role not found
 */
roleRoutes.delete("/delete/:id", Roles_1.deleteRole);
