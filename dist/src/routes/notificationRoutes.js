 ...
 *         description: Internal server error
 */
notificationRoutes.get("/admin/all", NotificationsController_1.getAllNotifications);
/**
 * @swagger
 ...
 *         description: Internal server error
 */
notificationRoutes.get("/types", NotificationsController_1.getNotificationTypes);
/**
 * @swagger
 ...
 *         description: Internal server error
 */
notificationRoutes.post("/enhanced/create", NotificationsController_1.createNotificationEndpoint);
/**
 * @swagger
 ...
 *         description: Internal server error
 */
notificationRoutes.post("/bulk/create", NotificationsController_1.createBulkNotificationEndpoint);
/**
 * @swagger
 ...
 *         description: Internal server error
 */
notificationRoutes.post("/role/create", NotificationsController_1.createRoleNotificationEndpoint);
