 ...
 *         description: Internal server error
 */
restockRequestRoutes.get("/", restockRequestController_1.getAllRestockRequests);
/**
 * @swagger
 ...
 *         description: Internal server error
 */
restockRequestRoutes.get("/:shopId", restockRequestController_1.getRestockRequests);
/**
 * @swagger
 ...
 *         description: Internal server error
 */
restockRequestRoutes.patch("/:id/status", restockRequestController_1.updateRestockRequestStatus);
/**
 * @swagger
 ...
 *         description: Internal server error
 */
restockRequestRoutes.post("/fulfill", restockRequestController_1.markRestockRequestFulfilled);
/**
 * @swagger
 ...
 *         description: Internal server error
 */
restockRequestRoutes.delete("/:id", restockRequestController_1.softDeleteRestockRequest);
