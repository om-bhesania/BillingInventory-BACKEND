...
searchRoutes.use(auth_1.authenticateToken);
searchRoutes.use(rateLimiter_1.userRateLimiter);
/**
 * @swagger
 * tags:
 *   name: Search
 ...
 */
searchRoutes.get("/", searchController_1.globalSearch);
/**
 * @swagger
 ...
 *         description: Internal server error
 */
searchRoutes.get("/suggestions", searchController_1.getSearchSuggestions);
/**
 * @swagger
 * /api/search/stats:
 *   get:
 ...
 *         description: Internal server error
 */
searchRoutes.get("/stats", searchController_1.getSearchStats);
