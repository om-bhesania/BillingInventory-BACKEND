...
exports.generateInsights = exports.getOperationalMetrics = exports.getCustomerAnalytics = exports.getProductPerformance = exports.getLiveMetrics = exports.getEnhancedDashboard = void 0;
...
const getEnhancedDashboard = async (req, res) => {
    try {
        ...
        const comparisonRange = calculateComparisonPeriod(dateRange, comparisonType);
        // Generate enhanced analytics
        const analytics = await enhancedAnalyticsService_1.enhancedAnalyticsService.generateAnalytics(dateRange, comparisonRange);
        ...
        logger_1.logger.info('Enhanced dashboard data generated', {
        ...
        logger_1.logger.error('Error generating enhanced dashboard:', error);
        res.status(500).json({
...
exports.getEnhancedDashboard = getEnhancedDashboard;
const getLiveMetrics = async (req, res) => {
    try {
        ...
        logger_1.logger.error('Error getting live metrics:', error);
        res.status(500).json({
...
exports.getLiveMetrics = getLiveMetrics;
const getProductPerformance = async (req, res) => {
    try {
        ...
        logger_1.logger.error('Error getting product performance:', error);
        res.status(500).json({
...
const getCustomerAnalytics = async (req, res) => {
    try {
        ...
        logger_1.logger.error('Error getting customer analytics:', error);
        res.status(500).json({
...
const getOperationalMetrics = async (req, res) => {
    try {
        ...
        const [totalShops, activeShops, lowStockItems, pendingRestockRequests, restockRequests, inventoryTurnover] = await Promise.all([
        ...
        logger_1.logger.error('Error getting operational metrics:', error);
        res.status(500).json({
...
// Helper functions
function calculateComparisonPeriod(dateRange, comparisonType) {
...
async function calculateInventoryTurnover(dateRange) {
...
function calculateAverageRestockTime(restockRequests) {
