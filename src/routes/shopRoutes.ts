 ...
 */
shopRoutes.delete("/:id/force", forceDeleteShop as RequestHandler);
 ...
 */
shopRoutes.post("/:id/link-manager", linkShopManager as RequestHandler);
 ...
 *         description: Shop not found
 */
shopRoutes.delete("/:id/unlink-manager", unlinkShopManager as RequestHandler);
 ...
 */
shopRoutes.delete("/:id/delete-all-data", deleteAllShopData as RequestHandler);
